...
<div class="nav-header">
	...
	<div class="maincontainer">
		<!-- Header -->
		<div class="header">
			<span class="lms-title">Delete User Here</span>
			<!-- <span class="login">
		...
		<div class="container signUp">
			<div class="box">
				<h3><!-- Join now --></h3>
				<form:form action="deleteUser" method='post' cssClass="form-signup" commandName="deleteUSer">
					...
					<div class="row">
						<div class="col-md-4">
						 ...
						 <div class="col-md-8">
							<form:input path="userId" cssClass="text-box"/>				
						</div> 						
					</div>
					<br> 
